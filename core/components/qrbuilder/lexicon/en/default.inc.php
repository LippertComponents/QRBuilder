...
$_lang['qrbuilder.grid.qr_code_path'] = 'QR Code PNG';// the path to the image
...
$_lang['qrbuilder.qrcode.qr_code_path'] = 'QR Code PNG, to Download right click and File Save As ';// the path to the image
